...
#
# HINT: lowest_cost_search is a generalized version of the bridge problem
...
inventory:
    ...
    action_cost function(action)
    path_cost

-> lowest_cost_search(start, successors, goal, action_cost) -> path
"""
...
# Verification with bridge problem
